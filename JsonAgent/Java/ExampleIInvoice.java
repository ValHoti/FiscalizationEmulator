public class ExampleIInvoice { public static void main(String[] a)throws Exception { BitSefClient c=new BitSefClient("http://127.0.0.1:5077","CHANGE-THIS-BIT-SEF-SECRET"); String json="{" + "\n" +
   "  \"type\": \"I\"," + "\n" +
