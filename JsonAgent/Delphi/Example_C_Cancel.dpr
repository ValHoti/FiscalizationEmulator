program Example_C_Cancel; {$APPTYPE CONSOLE} uses System.SysUtils, BitSefClient; var C:TBitSefClient;J:string; begin C:=TBitSefClient.Create('http://127.0.0.1:5077','CHANGE-THIS-BIT-SEF-SECRET'); try J:='{' + sLineBreak +
 '  "type": "C",' + sLineBreak +
